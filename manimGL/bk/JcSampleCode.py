...
#  bernoiulli distribution BarChart
class Ber(Scene):
    def construct(self):
        # screen_grid = ScreenGrid()
        # self.add(screen_grid)
...
# bernoiulli distribution BarChart by ValueTracker
class Ber1(Scene):
    def construct(self):
        # screen_grid = ScreenGrid()
        # self.add(screen_grid)
...
class Ber2(Scene):
    def construct(self):
        ...
        p.add_updater(lambda m: m.set_value(v.get_value()))
        p.move_to(UP * 3)
...
class coords_to_point_example(GraphScene):
    def construct(self):
        # screen_grid = ScreenGrid()
        # self.add(screen_grid)
